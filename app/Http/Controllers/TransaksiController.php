...
class TransaksiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/transaksi/bayar/'.$invoice)->with('message', 'User added successfully!');
    }
    ...
    public function tambahbiaya(Request $req,$id)
    {
        ...
        return redirect('/admin/laporan-transaksi/'.$transaksi->kode_invoice);
    }
    ...
    public function update(Request $req, $id)
    {
        ...
        return redirect()->route('transaksi.index')->with('message', 'transaksi updated successfully!');
    }
