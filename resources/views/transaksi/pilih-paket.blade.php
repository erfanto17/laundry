        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-4 col-12 mb-3">
                    <button class="btn btn-success w-100" onclick="return pilihpaket({{$transaksi->id}},{{$row->id}})">
            ...
            @endforeach
                <form action="/admin/add-diskon/{{ $transaksi->id }}" method="post">
        @csrf
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="datetime-local" style=" border-bottom: 2px solid black;"
                        class="form-control @error('batas_waktu') is-invalid @enderror" name="batas_waktu"
                        id="batas_waktu" placeholder="nama paket" autocomplete="off"
            ...
            {{-- <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select class="form-select form-control @error('status') is-invalid @enderror"
                        ...
                        <option selected name="jenis">Status</option>
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select class="form-select form-control @error('dibayar') is-invalid @enderror"
                        name="dibayar" id="dibayar" placeholder="Dibayar " autocomplete="off"
                        value="{{ old('dibayar') }}" style=" border-bottom: 2px solid black;">
                        <option selected name="dibayar">Dibayar</option>
            ...
            <div class="col-md-4 col-12">
                <div class="form-group">
                    ...
                    <input type="text" style=" border-bottom: 2px solid black;"
                        class="form-control @error('biaya_tambahan') is-invalid @enderror" name="biaya_tambahan"
                        id="biaya_tambahan" placeholder="nama paket" autocomplete="off"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('hapus-paket', $dtl->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit" class="btn btn-sm btn-danger" style="border-radius: 13px;"
                                                            onclick="return confirm('Are you sure to delete this?')"><i class="fas fa-fw fa-trash"></i></button>
                                                    </form>
                                                </td>
    ...
    function addpaket(id_transaksi,$id_paket)
        {
            $.ajax({
                  type: 'post',
                  url: '/admin/add-paket/'+id_transaksi+ '/' + $id_paket,
